...
module.exports = {
    ...
    async delete(req, res){
        const {_id} = req.params;
        const product = await Produto.findByIdAndDelete({_id}) // _id:id
    ...
    async update(req, res) {
        ...
        const product = await Produto.findOneAndUpdate({_id}, data,{new:true}); // new:true retorna os dados novos do usuário
        res.json(product);
    }
}